...
public class BeforeAndAfterClass {
	/**
	 * This is the first method will be executed in this program. As Before Suite
	...
	/**
	 * This is the last method will be executed in this program. As After Suite will
	 * be executed last And the order is not important that this is the second
	 * method in the Program. Though it will execute at last
	 */
	@AfterSuite
	...
	/**
	 * Before Test method will be executed before the first test-method mentioned in
	 * each test inside the 'test' tag in testng.xml file.
	 */
	@BeforeTest
	...
	/**
	 * After Test method will be executed after the last test-method mentioned in
	 * each test inside the 'test' tag in testng.xml file.
	 */
	@AfterTest
	...
	/**
	 * Before Class method will be executed before any of the test-methods inside a
	 * class.
	 */
	@BeforeClass
	...
	/**
	 * After Class method will be executed After any of the test-methods inside a
	 * class.
	 */
	@AfterClass
	...
	/**
	 * Before group method will be executed before executing any of the tests
	 * belonging to the group as mentioned in the 'groups' attribute. The following
	...
	/**
	 * After group method will be executed after executing any of the tests
	 * belonging to the group as mentioned in the 'groups' attribute. The following
