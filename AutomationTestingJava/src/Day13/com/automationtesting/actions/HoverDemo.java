...
public class HoverDemo {
	...
	public static void main(String[] args) {
		 ...
		 * "//*[@class='ui-grid-canvas']/div[1]/div/div[6]/user-click-select/div[1]/button/i"
		...
		WebElement deleteIcon = driver.findElement(
				By.xpath("//*[@class='ui-grid-canvas']/div[1]/div/div[6]/user-click-select/div[1]/del-click/button/i"));
